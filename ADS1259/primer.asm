...
_0x0:
	.DB  0x20,0x25,0x39,0x2E,0x33,0x66,0x20,0x20
	.DB  0x25,0x33,0x2E,0x30,0x66,0x20,0x20,0x20
	.DB  0x25,0x31,0x30,0x2E,0x37,0x66,0x20,0xD
	.DB  0xA,0x20,0x0,0x25,0x39,0x2E,0x33,0x66
	.DB  0x20,0x25,0x39,0x2E,0x35,0x66,0x20,0x20
	.DB  0x20,0xD,0xA,0x20,0x0
_0x2000000:
...
;
;
;// ќптимизировать задержки (до 2us)
;char spi_rw(char address, char value, char cs_pin)
; 0001 0009 {

	.CSEG
; 0001 000A     char data = 0;
; 0001 000B     PORTB = PORTB & ~(1 << cs_pin); // set 0 in cs_pin
;	address -> Y+3
;	value -> Y+2
;	cs_pin -> Y+1
;	data -> R17
; 0001 000C     spi(address);
; 0001 000D     delay_us(1);
; 0001 000E     data = spi(value);
; 0001 000F     delay_us(1);
; 0001 0010     PORTB = PORTB | (1 << cs_pin); // set 1 in cs_pin
; 0001 0011     delay_us(1);
; 0001 0012     return data;
; 0001 0013 }
	#ifndef __SLEEP_DEFINED__
	#define __SLEEP_DEFINED__
	.EQU __se_bit=0x01
